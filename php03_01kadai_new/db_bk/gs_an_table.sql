...
--
-- Host: localhost
-- Generation Time: 2018 年 9 月 29 日 05:20
-- サーバのバージョン： 5.6.21
-- PHP Version: 5.6.3
...
CREATE TABLE IF NOT EXISTS `gs_tr_table` (
`id` int(12) NOT NULL,
  `name` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
  `kuni` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `recom` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
...
(1, '山崎大助1', 'test@test.jp', 'ちょっと暑いです。教室。\r\nまじです。', '2018-09-22 07:28:23', 40),
(2, '織田信長', 'test1@test.jp', 'メモ', '2018-09-22 16:02:47', 20),
